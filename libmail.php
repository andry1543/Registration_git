...
/*
  ...
  после email вы создаете дополнительный ресурс c указанным id. ID ресурса может быть любая строка из цифр и букв латинского алфавита.
  Когда будет идти отправка, то все объединяться в рессурсы и какждый рессурс отправит письмо.
  Например если хотите чтобы и темы письма были индивидуальны, то точно так же следующий параметр после названия темы указываете ресурс,
